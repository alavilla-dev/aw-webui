<template lang="pug">
  div
    b-alert(v-if="isVisible", variant="info", show)
      ...
      | #[a(href="https://github.com/alavilla-dev/cepem-watch/releases" target="_blank" class="alert-link") download],
    ...
    async retrieveLatestVersion() {
      try {
        const response = await axios.get(
          'https://api.github.com/repos/alavilla-dev/cepem-watch/releases/latest'
        );
