...
div
  ...
  div.row
    div.col-md-6
      ...
      ul
        li #[a(href="https://cepem.com.ar" target="_blank" rel="noopener noreferrer") {{ $t('home.website') }}]
        li #[a(href="https://github.com/alavilla-dev/cepem-watch" target="_blank" rel="noopener noreferrer") GitHub]
...
export default {
  ...
  computed: {
    ...
    supporterNudgeHref(): string {
      return `https://cepem.com.ar/?src=${this.supporterNudgeSrc}`;
    },
  },
  mounted() {
